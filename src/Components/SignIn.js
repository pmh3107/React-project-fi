...
function FormSignIn() {
  ...
  const buttonData = [
    {
      class: "btn--primary auth__btn form__submit-btn",
      nameBtn: "Đăng nhập",
    },
    {
      class: "btn--outline auth__btn btn--no-margin",
      nameBtn: "Đăng nhập với google",
    },
  ];
  return (
    <form action="./" className="form auth__form">
      ...
      <div className="form__group auth__btn-group">
        {buttonData.map((content, index) => (
          <ButtonPrimary
            key={index}
            className={content.class}
            name={content.nameBtn}
          />
        ))}
      </div>
    </form>
        ...
        <div className="auth__content">
          <div className="auth__content-inner">
            ...
            <p className="auth__text">
              ...
              <a href="./sign-up.html" className="auth__link auth__text-link">
                Đăng kí
              </a>
            </p>
          </div>
